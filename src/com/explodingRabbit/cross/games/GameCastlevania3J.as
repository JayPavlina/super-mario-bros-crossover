package com.explodingRabbit.cross.games
{
	...
	public class GameCastlevania3J extends Game
	{
		private static var instance:Game; 
		
		public function GameCastlevania3J(gameNum:int, skinSetNum:int = -1)
		{
			super("Akumajo Densetsu", "Konami", Consoles.nintendo, gameNum, "Castlevania III", skinSetNum);
			if (instance)
				throw new SingletonError();
			instance = this;
		}
		
		[Embed(source="../../../../../assets/audio/seq/nsf/AkumajoDensetsu.nsf", mimeType="application/octet-stream")]
