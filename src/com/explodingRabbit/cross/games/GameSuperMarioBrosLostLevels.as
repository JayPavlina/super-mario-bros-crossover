package com.explodingRabbit.cross.games
{
	...
	public class GameSuperMarioBrosLostLevels extends Game
	{
		...
		public static const NUM_WORLDS:int = 13;
		public function GameSuperMarioBrosLostLevels(gameNum:int, skinSetNum:int)
		{
			super("SMB: Lost Levels", "Nintendo", Consoles.nintendo, gameNum, null, skinSetNum);
			if (instance)
		...
		private const TG_OVERWORLD_CASTLE_WALL:ThemeGroup = addThemeGroup( 1, 6 );
		private const TG_UNDERGROUND:ThemeGroup = addThemeGroup( 1, 7 );
		private const TG_UNDERGROUND_SCENERY:ThemeGroup = addThemeGroup( 1, 8 );
		private const TG_UNDERGROUND_WATER:ThemeGroup = addThemeGroup( 1, 9 );
		private const TG_WATER:ThemeGroup = addThemeGroup( 2, 1 );
		private const TG_WATER_NIGHT:ThemeGroup = addThemeGroup( 2, 2 );
		private const TG_CASTLE:ThemeGroup = addThemeGroup( 3, 1 );
		private const TG_CASTLE_WATER:ThemeGroup = addThemeGroup( 3, 2 );
		private const TG_CLOUDS:ThemeGroup = addThemeGroup( 4, 1 );  
		private const TG_CLOUDS_OVERWORLD:ThemeGroup = addThemeGroup( 4, 2 );
		...
		private const TG_COIN_HEAVEN_BLUE:ThemeGroup = addThemeGroup( 5, 4 );
		private const TG_OVERWORLD_WATER:ThemeGroup = addThemeGroup( 6, 1 );
		...
		override protected function setUpLevelThemes():void
		{
			...
			addToThemeInfoWorld( 3, TG_OVERWORLD_SNOW_NIGHT, LT_NORMAL, LT_PLATFORM );
			addToThemeInfoWorld( 3, TG_COIN_HEAVEN_NIGHT, LT_COIN_HEAVEN );
			
			addToThemeInfoWorld( 4, TG_CLOUDS_OVERWORLD, LT_NORMAL );
			addToThemeInfoWorld( 4, TG_CLOUDS, LT_PLATFORM );
			...
			addToThemeInfoWorld( 8, TG_OVERWORLD, LT_NORMAL );
			...
			addToThemeInfoGeneral( TG_CLOUDS, "3-2b", "8-3c" );
			...
			addToThemeInfoWorld( 5, TG_OVERWORLD_SNOW, LT_NORMAL );
			addToThemeInfoWorld( 5, TG_UNDERGROUND, LT_PIPE_BONUS );
			...
			addToThemeInfoWorld( 8, TG_CLOUDS, LT_NORMAL, LT_PLATFORM );
			addToThemeInfoWorld( 9, TG_OVERWORLD_WATER, LT_WATER );
			addToThemeInfoWorld( 9, TG_COIN_HEAVEN_GRAY, LT_COIN_HEAVEN );
			addToThemeInfoWorld( 10, TG_CLOUDS, LT_NORMAL, LT_PLATFORM );
			...
			addToThemeInfoGeneral( TG_OVERWORLD, "3-2a", "3-2c", "4-3a", "5-2a", "5-2c", "5-2d", "5-3a", "10-2a", "13-4b" );
